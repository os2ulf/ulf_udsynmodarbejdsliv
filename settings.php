...
// Search templates
# $conf['search_template_box_courses_dagtilbud'] = 'sites/ungegarantien.dk/themes/ulf_hjoerring/templates/search/angular/search-daycare.html';
# $conf['search_template_box_courses_grundskole'] = 'sites/ungegarantien.dk/themes/ulf_hjoerring/templates/search/angular/search-school.html';
# $conf['search_template_box_courses_ungdomsuddannelse'] = 'sites/ungegarantien.dk/themes/ulf_hjoerring/templates/search/angular/search-youth.html';
# $conf['search_template_box_users'] = '';
...
if (file_exists($dir . '/all/settings.platformsh.php')) {
  $platformsh_subsite_id = 'ulf_hjoerring';
